...
Path settings
"""
cfg.CONFIG_DIR = os.path.dirname(f'{os.path.abspath(__file__)}')
cfg.ROOT_DIR = os.path.abspath(f'{cfg.CONFIG_DIR}/../..')
cfg.PKG_DIR = f'{cfg.ROOT_DIR}/pvnet_rendering'
...
cfg.BLENDER_DIR = os.path.join(cfg.PKG_DIR, "blender")
...
cfg.MATERIAL_PATH = '/home/clayton/workspace/prj/data_keep/data/misc_dataset/new/hsr_ply/hsr_material.001.jpg'
